            ...
            <div class="vocab__adaptive-box">
                ...
                <div class="vocab__controls">
                    <div class="vocab__sort sort sort-actual">
                        <button class="sort__new"></button>
                        <button class="sort__shuffle"></button>
                        <button class="sort__sort"></button>
                        <button class="sort__stats" data-sort="asc"></button>
                        <button class="sort__stats sort__stats--desc" data-sort="desc"></button>
                    </div>
                </div>
            </div>
        </div>
...
const makeModals = () => `
    ...
    <div class="modal congrats">
        <svg class="congrats__cross" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M23.954 21.03l-9.184-9.095 9.092-9.174-2.832-2.807-9.09 9.179-9.176-9.088-2.81 2.81 9.186 
                9.105-9.095 9.184 2.81 2.81 9.112-9.192 9.18 9.1z"/>
        </svg>
        <form class="congrats__form">
            <div class="congrats__message">
                <h1 class="congrats__title">Excellent work!</h1>
                <h3 class="congrats__subtitle">10 out of 10!</h3>
            </div>
            <button class="congrats__btn">I know</button>
        </form>
    </div>
